    ...
    <!-- 変更箇所　ここまで↑ -->
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1 w-full focus:border-orange-500 focus:ring focus:ring-orange-200 focus:ring-opacity-50 bg-orange-100" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
