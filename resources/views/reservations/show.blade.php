...
<x-user-menu />
    ...
    <!-- 予約詳細カード -->
    <div class="mt-10 max-w-md mx-auto p-6 rounded-2xl shadow relative"
        ...
        <!-- 左下のチューリップ -->
        <img src="{{ asset('img/flower2.png') }}" alt="チューリップ" class="absolute bottom-[-3px] left-0 w-20 h-auto">
        <!-- 右下のうさぎ -->
        <img src="{{ asset('img/rabbit.png') }}" alt="うさぎ" class="absolute bottom-[-5px] right-[-9px] w-20 h-auto">
    </div>
