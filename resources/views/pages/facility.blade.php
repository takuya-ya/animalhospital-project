<x-app-layout>
    ...
    <div class="m-auto max-w-[960px]">
        {{-- 本文 --}}
        <div class="px-4 py-6">
            <h1 class="text-3xl font-bold text-center mt-6 mb-3" style="color:#715433">院内・設備紹介</h1>
        ...
        <div class="px-4 mb-10 grid grid-cols-1 sm:grid-cols-2 gap-10 p-10">

            {{-- 草食動物・小動物優先待合 --}}
            <div class="rounded-xl flex flex-col space-y-2">
                <img src="{{ asset('images/facilities-Inside-01.png') }}" class="h-[260px] rounded-xl object-cover" alt="草食動物画像">
            ...
            {{-- 肉食動物優先待合 --}}
            <div class="rounded-xl flex flex-col space-y-2">
                <img src="{{ asset('images/facilities-Inside-02.png') }}" class="h-[260px] rounded-xl object-cover" alt="肉食動物優先待合画像">
            ...
            {{-- 集中治療用入院舎  --}}
            <div class="rounded-xl flex flex-col space-y-2">
                <img src="{{ asset('images/facilities-Inside-03.png') }}" class="h-[260px] rounded-xl object-cover" alt="集中治療用画像">
            ...
            {{-- 資料室 --}}
            <div class="rounded-xl flex flex-col space-y-2">
                <img src="{{ asset('images/facilities-Inside-07.png') }}" class="h-[260px] rounded-xl object-cover" alt="資料室画像">
            ...
            {{-- 飼育室 --}}
            <div class="rounded-xl flex flex-col space-y-2">
                <img src="{{ asset('images/facilities-Inside-08.png') }}" class="h-[260px] rounded-xl object-cover" alt="飼育室画像">
        ...
        <div id="pet-hotel" class="px-4 rounded-xl border-4 border-orange-400 scroll-mt-40"
            style="background-color: rgba(176, 243, 59, 0.2);">
            <div class="w-full flex flex-col md:flex-row items-center justify-center gap-y-1 md:space-y-5 md:space-x-6 mb-10">
                <!-- 左画像 -->
                <img src="{{ asset('images/facility-hotel-lt.png') }}"
                    class="w-[100px] md:w-[150px] rounded-xl object-cover self-start mt-2 -mb-10 md:self-center"
                    alt="飼育室画像">
                <!-- 見出し -->
                <h2 class="text-[27px] font-bold text-center" style="color:#FD8C07">小動物・<br class="block md:hidden">エキゾチックアニマル専用<br>ペットホテル</h2>
                <!-- 右画像 -->
                <img src="{{ asset('images/facility-hotel-rt.png') }}"
                    class="w-[100px] md:w-[150px] rounded-xl object-cover self-end -mt-6 -mb-5 md:self-center"
                    alt="飼育室画像">
            </div>
            <img src="{{ asset('images/facility-hotel-phot-01.png') }}" class="mx-auto rounded-xl" alt="ペットと二人画像">
            ...
            <div class="flex flex-col w-[306px] mx-auto md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 mb-10">
                <img src="{{ asset('images/facility-hotel-phot-02.png') }}" class="h-60 md:w-96 rounded-xl object-cover" alt="カメ画像">
                <img src="{{ asset('images/facility-hotel-phot-03.png') }}" class="h-60 md:w-96 rounded-xl object-cover" alt="ネコ用画像">
            </div>
        </div>
    </div>
