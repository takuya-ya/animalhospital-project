<x-app-layout>
    ...
    <div class="py-12" style="background-color: #FFFDEA;">
        ...
        <div class="w-[400px] mx-auto mt-10 p-6 border-2 border-orange-300 rounded-xl bg-[#fffcee] relative"
            ...
            <!-- 左下のチューリップ（もう少し下に） -->
            <img src="/img/flower2.png" alt="チューリップ" class="absolute bottom-[-3px] left-1 w-20 h-auto">
            <!-- 右下のうさぎ（もっと右に） -->
            <img src="/img/rabbit.png" alt="うさぎ" class="absolute bottom-[-5px] right-[-9px] w-24 h-auto">
        </div>
    </div>
